module.exports = {
    ...
    fn: async function (inputs, exits) {
      ...
      try {
        // const checkBuyer = await sails.models.propertybuyer.findOne({
        //   property_id:inputs.property_id,
        //   deleted_at: null
        // })
        // if(checkBuyer){
        //   return exits.invalid({ status: false, data: [], message: 'Buyer already exist for this property ' });
      ...
      //  const is_cda_sent =  inputs.is_cda_sent == 'true' ? 1 : 0;
        ...
        const data = await PropertyBuyer.updateOne({id: inputs.id}).set(obj);
