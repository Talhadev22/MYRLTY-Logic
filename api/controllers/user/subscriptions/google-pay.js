...
module.exports = {
  ...
  friendlyName: 'Purchase subs using google pay',


  description: 'Purchase subs using google pay',
  ...
  fn: async function (inputs, exits) {
    try {
      ...
      sails.log.debug('action subscription/google-pay.js called with inputs: ', JSON.stringify(inputs), '\nTime: ', moment().format())
    ...
    if (!user_update) {
            sails.log.debug('action subscription/google-pay.js called with inputs: User not found \nTime: ', moment().format())
            return exits.success({
            status: false,
      ...
      sails.log.error('action subscription/google-pay.js called with inputs execution failed: ', error, ' \nTime: ', moment().format())
      return exits.success({
        status: false,
